              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        'Selasar Kopi & Ruang Diskusi - Tebet',
                        style:
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    color:
                        AppTheme.onPrimaryFixed.withValues(alpha: 0.8),
                  ),
                ),
              ],
            ),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _buildStatRow(context, 'Rata-rata waktu tunggu', '8 menit',
                  AppTheme.primary),
              Divider(color: AppTheme.outlineVariant),
              _buildStatRow(context, 'Kepuasan pelanggan',
                  '94%', AppTheme.tertiary),
              Divider(color: AppTheme.outlineVariant),
              _buildStatRow(context, 'Pesanan tepat waktu',
                  '96%', AppTheme.secondary),
            ],
          ),
        ),
      ],
